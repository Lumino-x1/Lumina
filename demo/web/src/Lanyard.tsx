...
export default function Lanyard({
  ...
  return (
    <div
      className={`relative z-10 w-full h-full min-h-[500px] flex justify-center items-center transform scale-100 origin-center ${className}`.trim()}
    >
      <Canvas
        camera={{ position, fov }}
