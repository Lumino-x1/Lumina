import { redis } from '../../../demo/api/config/config.redis'
import {
  LEETCODE_JOB_DAILY_SYNC,
  LEETCODE_JOB_SYNC_PROFILE,
  LEETCODE_QUEUE_NAME,
} from '../../../demo/api/config/leetcode.queue'
import { runLeetcodeDailySync } from '../../../demo/api/cron/leetcode.daily-sync.job'
import { syncProfileById } from '../../../demo/api/modules/leetcode/leetcode.sync.service'
import {
